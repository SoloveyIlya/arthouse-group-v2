    ...
    function updateProductModalContent(productId) {
      ...
      const productData = {
        ...
        'd50': {
          ...
          external_protection: 'Каркас конструкции из оцинкованной стали система|Алюминий с фторуглеродным напылением модуль корпуса из сплава|Теплоизоляция, водонепроницаемость и влагостойкая конструктивная система|Полый ламинированный закаленный стеклянный световой люк|Трехслойный полый закаленный стекло от пола до потолка|Стандартная распашная входная дверь',
          guest_control: 'Освещение/Электрические шторы|Интеллектуальная система контроля доступа для отелей',
          accessories: 'Опорные ножки совмещены по нижняя часть изделия|Подъемные кольца / Транспортировочные приспособления',
          interior: 'Интегрированные модули потолка и стен|Напольное покрытие из каменного кристалла с текстурой дерева|Ванная комната с дверью из матового стекла|Душевая комната/Мрамор/Плитка на полу|Раковина/Мойка/Зеркало в ванной|Крючки для одежды/Полка для душа/Вешалка для полотенец|Брендовая водопроводная арматура/Душевая лейка/Напольный слив|Система освещения всего дома|Водопроводная и электрическая система всего дома|Стандартные затемняющие шторы|Кондиционер (охлаждение и обогрев)|Электрический водонагреватель|Система вентиляции|Защита всего дома от комаров|4-в-1 потолочный обогреватель для ванной с освещением, обогревом, вентиляцией и вентилятором|Брендовый умный туалет|Электрический подогрев пола',
          optional: ['UV-resistant Heat-insulating Explosion-proof Film (High-transparency/Privacy)', 'Thickened Insulation Layer', 'Smart Voice System', 'Starry Sky Skylight', 'Projector + projection screen', 'International Kitchen Integrated Customization', 'Kitchen Cabinets/Wall Cabinets (Including Sink/Water Tap)', 'Range Hood/Induction Cooker/Refrigerator', 'Custom bar counter', 'Custom wardrobe', 'Entrance Staircase', 'Triangular V-brace', 'Entrance Platform']
        },
        'sleepbox': {
          title: 'SleepBox',
          price: '$12,500',
          ...
          guest_control: 'Освещение/Электрические шторы|Интеллектуальная система контроля доступа для отелей',
          accessories: 'Опорные ножки совмещены по нижняя часть изделия|Подъемные кольца / Транспортировочные приспособления',
          interior: 'Интегрированные модули потолка и стен|Напольное покрытие из каменного кристалла с текстурой дерева|Ванная комната с дверью из матового стекла|Душевая комната/Мрамор/Плитка на полу|Раковина/Мойка/Зеркало в ванной|Крючки для одежды/Полка для душа/Вешалка для полотенец|Брендовая водопроводная арматура/Душевая лейка/Напольный слив|Система освещения всего дома|Водопроводная и электрическая система всего дома|Стандартные затемняющие шторы|Кондиционер (охлаждение и обогрев)|Электрический водонагреватель|Система вентиляции|Защита всего дома от комаров|Брендовый умный туалет|Электрический подогрев пола|Умное голосовое управление|4-в-1 потолочный обогреватель для ванной с освещением, обогревом, вентиляцией и вентилятором|Микро-вентиляционное окно',
          optional: []
        },
        'l50': {
        ...
        'w6': {
          ...
          image: './media/catalog/W6.png',
          gallery: [
            './media/catalog/W6-view1.webp',
            './media/catalog/W6-view2.webp',
            './media/catalog/W6-view3.webp'
          ],
          characteristics: [
        ...
        'w9': {
          ...
          image: './media/catalog/W9.png',
          gallery: [
            './media/catalog/W9-interier.webp',
            './media/catalog/W9-scaled.webp'
          ],
          characteristics: [
        ...
        'sa30': {
          ...
          characteristics: [
            ...
            { label: 'ВМЕСТИМОСТЬ', value: '2 чел.', icon: '<path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/>' },
            { label: 'РАЗМЕРЫ', value: '6.5×3.48×3.3 м', icon: '<path d="M3 3h18v18H3V3zm2 2v14h14V5H5zm2 2h10v10H7V7z"/>' },
            { label: 'ОБЩИЙ ВЕС НЕТТО', value: '≈4.3 тонны', icon: '<path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/>' }
          ],
          external_protection: '',
          guest_control: '',
          accessories: '',
          interior: 'Изолированное низкоэмиссионное закаленное стекло|SMC модульная ванная комната|Туалет и водяной бак, туалетный столик, настенный шкаф|Душевой смеситель и душевая штанга, вешалка для полотенец|Кондиционер|Кухня и кухонная техника|Система солнечной энергии|Водяной бак',
          optional: ['Комфортные улучшения', 'Аксессуары и периферия', 'Электротехническая проводка и освещение']
        },
        'sa50': {
          ...
          characteristics: [
            ...
            { label: 'ВМЕСТИМОСТЬ', value: '2-4 чел.', icon: '<path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/>' },
            { label: 'РАЗМЕРЫ', value: '8.94×3.48×3.3 м', icon: '<path d="M3 3h18v18H3V3zm2 2v14h14V5H5zm2 2h10v10H7V7z"/>' },
            { label: 'ОБЩИЙ ВЕС НЕТТО', value: '≈5.5 тонны', icon: '<path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/>' }
          ],
          external_protection: '',
          guest_control: '',
          accessories: '',
